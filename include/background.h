...
struct background
{
  ...
  double B_fld;                /**<AS parameter */
  double rho_star;         /**<Planck density */
  double aGRB;
  double bGRB;
  double sigex;
  ...
  int index_bg_rho_new;       /**< new matter density */
  ...
  short has_new;       /**< presence of a new type of matter? */
...
extern "C" {
  ...
  int background_rs_modified(
                      struct background *pba
                      );
                      
  int background_rd_modified(
                      struct background *pba
                      );
