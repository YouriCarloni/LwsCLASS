...
struct perturbations
{
  ...
  short has_source_delta_new;  /**< do we need source for delta of the new matter fluid? */
  ...
  short has_source_theta_new;  /**< do we need source for theta of the new matter fluid? */
  ...
  int index_tp_delta_new;  /**< index value for delta of the new matter fluid */
  ...
  int index_tp_theta_new;   /**< index value for theta of the new matter fluid */
...
struct perturbations_vector
{
  ...
  int index_pt_delta_new;  /**< new matter fluid density */
  int index_pt_theta_new;  /**< new matter fluid velocity*/
...
struct perturbations_workspace
{
  ...
  */
  ...
  double delta_rho_new;        /**< relative density perturbation of the new matter fluid */
  double delta_p_new;          /**< pressure perturbation of the new matter fluid */
