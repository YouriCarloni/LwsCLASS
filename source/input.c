...
int input_read_parameters_species(struct file_content * pfc,
  ...
  class_call(parser_read_double(pfc,"aGRB",&param1,&flag1,errmsg),
             errmsg,
             errmsg);
  /* Compability code END */
  class_call(parser_read_double(pfc,"bGRB",&param2,&flag2,errmsg),
             errmsg,
             errmsg);
  class_call(parser_read_double(pfc,"sigex",&param3,&flag3,errmsg),
             errmsg,
             errmsg);
  ...
  if (pba->K > 0.){
   ...
   /** 7) Omega_0_new (effective fractional density of new matter) */
  /* else: keep whatever default you already set for pba->Omega_new */
  ...
  if (pba->Omega0_fld != 0.) {
    ...
    if (flag1 == _TRUE_) {
      ...
      else if ((strstr(string1,"AS0") != NULL) || (strstr(string1,"as0") != NULL)) {
        pba->fluid_equation_of_state = AS0;
        }
      else if ((strstr(string1,"OS1") != NULL) || (strstr(string1,"os1") != NULL)) {
        pba->fluid_equation_of_state = OS1;
        }
      else if ((strstr(string1,"OS2") != NULL) || (strstr(string1,"os2") != NULL)) {
        pba->fluid_equation_of_state = OS2;
        }
      ...
      else if ((strstr(string1,"PADE1") != NULL) || (strstr(string1,"pade1") != NULL)) {
        pba->fluid_equation_of_state = PADE1;
      }
      else if ((strstr(string1,"PADE2") != NULL) || (strstr(string1,"pade2") != NULL)) {
        pba->fluid_equation_of_state = PADE2;
      }
      else if ((strstr(string1,"PADE0") != NULL) || (strstr(string1,"pade0") != NULL)) {
        pba->fluid_equation_of_state = PADE0;
      }
      else {
    ...
    if (pba->fluid_equation_of_state == AS0) {
      /** 8.a.2.3) Equation of state of the fluid in 'EDE' case */
      /* Read */
      class_read_double("B_fld",pba->B_fld);
      class_read_double("rho_star",pba->rho_star);
      class_read_double("cs2_fld",pba->cs2_fld);
    }
    if (pba->fluid_equation_of_state == OS1) {
      /** 8.a.2.3) Equation of state of the fluid in 'EDE' case */
      /* Read */
      class_read_double("w0_fld",pba->w0_fld);
      class_read_double("wa_fld",pba->wa_fld);
    ...
    if (pba->fluid_equation_of_state == OS2) {
      /** 8.a.2.3) Equation of state of the fluid in 'EDE' case */
      /* Read */
      class_read_double("w0_fld",pba->w0_fld);
      class_read_double("wa_fld",pba->wa_fld);
    ...
    if (pba->fluid_equation_of_state == PADE1) {
      ...
      class_read_double("w0_fld",pba->w0_fld);
      class_read_double("wb_fld",pba->wb_fld);
      class_read_double("wc_fld",pba->wc_fld);
      class_read_double("cs2_fld", pba->cs2_fld);
    }
    if (pba->fluid_equation_of_state == PADE2) {
      /** 8.a.2.3) Equation of state of the fluid in 'EDE' case */
      /* Read */
      class_read_double("w0_fld",pba->w0_fld);
      class_read_double("wa_fld",pba->wa_fld);
    ...
    if (pba->fluid_equation_of_state == PADE0) {
      /** 8.a.2.3) Equation of state of the fluid in 'EDE' case */
      /* Read */
      class_read_double("w0_fld",pba->w0_fld);
      class_read_double("cs2_fld", pba->cs2_fld);
