    ...
    def get_current_derived_parameters(self, names):
        ...
        for name in names:
            if name == 'h':
                ...
                value = self.ba.rs_mod
            elif name == 'rd_mod':
                value = self.ba.rd_mod
            elif name == 'age':
                value = self.ba.age
                ...
                value = self.ba.wb_fld
            elif name == 'wc_fld':
                value = self.ba.wc_fld
            elif name == 'wd_fld':
                value = self.ba.wd_fld
            elif name == 'aGRB':
                value = self.ba.aGRB
            elif name == 'bGRB':
                value = self.ba.bGRB
                ...
                value = self.ba.Omega0_r
            elif name == 'Omega0_ur':
                value = self.ba.Omega0_ur
            elif name == 'Omega0_g':
